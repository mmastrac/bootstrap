...
./vm /tmp/t4.bin
echo Compile 4
./vm /tmp/b3.bin -l -I $ROOT/include $ROOT/bootstrap4/*.s $ROOT/bootstrap4/lex0/lex.s $ROOT/bootstrap4/lex0/lex_io.s $ROOT/bootstrap4/lex0/tests/*.s /tmp/t4.bin
./vm /tmp/t4.bin
echo Compile 4
./vm /tmp/b3.bin -l -I $ROOT/include $ROOT/bootstrap4/*.s $ROOT/bootstrap4/lex0/*.s /tmp/t4.bin
./vm /tmp/t4.bin
